...
Original file is located at
    https://colab.research.google.com/drive/143Oyi5keip4qDVPHDDGfSlxGTEAariYX
"""

# Declarando o dicionário para armazenar funcionários
funcionarios = {}
proximo_id = 1  # Variável para gerar um ID único para cada funcionário

def adicionar_funcionario():
    global proximo_id, funcionarios
    print('\n***Cadastro de Novo Funcionário***')
    nome = input('Digite o nome: ')
    cidade = input('Agora nos informe a cidade: ')
    estado = input('Nos informe o estado onde reside: ')
    idade = input('I]Nos informe sua idade: ')
    escolaridade = input('Agora nos informe sua escolaridade: ')
    cargo = input('Por último, nos informe o seu cargo: ')
